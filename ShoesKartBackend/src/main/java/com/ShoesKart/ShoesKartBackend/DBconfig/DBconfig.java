package com.ShoesKart.ShoesKartBackend.DBconfig;
...
@Configuration
@ComponentScan("com.ShoesKart.ShoesKartBackend")
...
public class DBconfig 
{
	...
	public DataSource getH2DataSource() 
	{
		...
		dataSource.setUrl(" jdbc:h2:tcp://localhost/~/MyProject");
	...
	public SessionFactory getSessionFactory(DataSource dataSource)
	{
		...
		sessionBuilder.scanPackages("com.ShoesKart.ShoesKartBackend.model");//Added
